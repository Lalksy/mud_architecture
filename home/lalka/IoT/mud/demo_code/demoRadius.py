...
'This example shows multiple station authentication with Radius Server'
...
def topology():
    ...
    sta1 = net.addStation( 'sta1', radius_passwd='hello', encrypt='wpa2', radius_identity='boby', position='110,80,0', ip='10.0.0.1' )
  
    sta2 = net.addStation( 'sta2', radius_passwd='MUDinmud', encrypt='wpa2', radius_identity='Merkle', position='190,80,0', ip='10.0.0.2' )
    
    ap1 = net.addAccessPoint( 'ap1', ssid='simplewifi1', authmode='8021x', shared_secret="testingMUD", mode='a', channel='36', encrypt='wpa2', position='150,100,0' )
